...
{
    public partial class ReportMonthly_Semifinished : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        [WebMethod]
        public static Dictionary<string, decimal> GetData(string organizationId, string datetime)
        {
            return ReportMonthly_SemifinishedService.GetReportData(organizationId, datetime);
        }
    }
}