...
{
    public partial class report_QueryBalanceStatistics : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        [WebMethod]
        public static Dictionary<string, string> GetReportDataSet(string organizationId, string dateTime, string statisticalType)
        {
            return QueryBalanceStatisticsService.GetDataSet(organizationId, dateTime, statisticalType);
        }
    }
}