...
function CreatHtmlStr() {
    ...
    $.ajax({
        type: "POST",
        url: "report_ClinkerStatistics.aspx/GetHtml",
...
function loadGridData(myType,startDate,endDate) {
    if (myType == 'first') {
        ...
        $.ajax({
            type: "POST",
            url: "report_ClinkerStatistics.aspx/GetReportData",
...
function onLoadSuccess(data) {
    ...
    $.ajax({
        type: "POST",
        url: "report_ClinkerStatistics.aspx/GetMerges",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
            var merges = msg.d;
...
function ExportFileFun() {
    ...
    var m_Parameter1 = GetDataGridTableHtml("gridMain_ReportTemplate", "熟料电耗统计报表", SelectDatetime);
    var m_Parameter2 = "";
    ...
    form.attr('action', "report_ClinkerStatistics.aspx");
...
function PrintFileFun() {
    var m_ReportTableHtml = GetDataGridTableHtml("gridMain_ReportTemplate", "熟料电耗统计报表", SelectDatetime);
